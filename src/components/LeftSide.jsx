...
return (
    <>
      <header className="text-white   ">
        {/* Navbar (left side) */}
        <div className="fixed flex  flex-col items-center justify-between h-[88vh]" >
          <div
            className="pr-3 flex flex-col justify-start max-h-[60%] "
          >
            {/*Logo*/}
            <svg
              viewBox="0 0 24 24"
            ...
            <div className="" style={{ bottom: "2rem" }}>
